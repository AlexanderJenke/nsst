...
Wie in\cite{hmm->wfsm} beschreiben wird, kann aus einem HMM ein gewichteter endlicher Automat abgeleitet werden, welcher die selbe Quellsprache erkennt.
...
Die Übergangsgewichte $P_A$ sind das Produkt aus der Transitionswahrscheinlichkeit $T_H$ mit der Emissionswahrscheinlichkeit $E_H$ des gelesenen Tokens im Zielzustand, wobei die Transitionswahrscheinlichkeit vom Startzustand zu einem anderen Zustand der Startwahrscheinlichkeit $I_H$ entspricht. Zu beachten ist, dass dieser Automat die Wahrscheinlichkeit der gelesenen Eingabe berechnet.
